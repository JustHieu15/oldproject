...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
            <h2 class="pt-3 pb-2 mb-3">Create Questions by Exam: {{ $getExam->name }}</h2>

            <form action="{{ route('admin.questions.storeByExam', $getExam->id) }}" method="POST">
                @csrf
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="hidden" class="form-control" id="exam" name="exam" value="{{ $getExam->id }}"
                        placeholder="Enter exam">

                    <input type="text" class="form-control" id="exam" name="exam" value="{{ $getExam->name }}"
                        placeholder="Enter exam" disabled>
                </div>
